...
loadTasks()
{
    ...
    let tasksHtml=this.tasks.reduce((html,task,index)=>html=html+this.generateTaskHtml(task,index),'');
...
<div class="row">
  ...
  <div class="col-md-1 col-xs-1 col-lg-1 col-sm-1 delete-icon-area">
    ...
    <i id="deleteTask" data-id="${index}" class="delete-icon glyphicon glyphicon-trash"></i></a>
  </div>
</div>
</li>`
}
